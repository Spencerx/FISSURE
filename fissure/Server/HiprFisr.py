...
class HiprFisr:
    ...
    async def send_cot(self, uid, callsign, lat, lon, alt, time, remarks, type:str="a-f-G-U-H"):
        ...
        await fissure.utils.tak_messages.send(self, msg)
    ...
    async def send_cot_gps_update(self, uid, callsign, lat, lon, alt, time, remarks, max_history=10):
        ...
        """
        # print("SEND TRACK")
        # if not hasattr(self, "_test_lon"):
        #    self._test_lon = lon   # initialize based on first call input
        # self._test_lon += 1
        # lon = self._test_lon
...
#     def __init__(self, logger, clitool):
#         self.logger = logger
#         self.past_positions = {}
...
#             "lon": lon,
#             "alt": alt,
#             "cot_type": "a-f-G-U-C",       # optional override
#             "stale": 60                    # 60 sec expiration window
#         }
